...
class RoleService(
    ...
    @Transactional
    fun save(role: RoleInfo): Mono<SysRoleEntity> {
    ...
    fun findAllByIds(ids: List<Long>): Flux<RoleInfo> {
        return roleRepository.findAllById(ids)
            .map { RoleInfo(it.id, it.name, it.code) }
    }

    // 【新增】单个查找
    fun findById(id: Long): Mono<RoleInfo> {
        return roleRepository.findById(id)
            .map { RoleInfo(it.id, it.name, it.code) }
    }
    ...
    // 【新增】角色回滚功能
    @Transactional
    fun rollback(historyId: Long): Mono<RoleInfo> {
        return historyRepository.findById(historyId)
            ...
            .flatMap { history ->
                ...
                roleRepository.save(entity)
                    ...
                    }.thenReturn(RoleInfo(entity.id, entity.name, entity.code))
            }
    }
