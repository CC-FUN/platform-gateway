...
class SystemController(
    ...
    fun getUserInfo(): Mono<StandardApiResponse<SysUser>> {
    ...
    fun listUsers(): Mono<StandardApiResponse<List<SysUser>>> {
        return SecurityUtils.getCurrentUsername()
            .flatMap { currentUsername ->
                authService.getUser(currentUsername)
            }
    ...
    // 辅助方法：检查角色越权
    private fun checkRoleEscalation(operator: SysUser, roleIds: List<Long>?): Mono<Void> {
