...
import cn.icofun.gateway.service.GrpcChannelManager
...
class GrpcTranscodingPlugin(
    ...
    private fun genericGrpcCall(
        ...
        // TODO: 真实集成时，此处应使用 protobuf-java-util 的 JsonFormat.parser()
        ...
        return """
            {
                ...
                "data": {
                    "service": "$service",
                    "method": "$method",
                    "channel_state": "${(channel as? io.grpc.ManagedChannel)?.getState(false)}",
                    "echo_request": $json
                }
            }
        """.trimIndent()
