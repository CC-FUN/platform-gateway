...
import cn.icofun.gateway.repository.SysMenuRepository
import cn.icofun.gateway.repository.SysRoleMenuRepository
import cn.icofun.gateway.repository.SysUserRoleRepository
...
class MenuService(
    ...
    fun findAll(): Flux<SysMenu> = menuRepository.findAll().map {
        SysMenu(
    ...
    @Transactional
    fun save(menu: SysMenu): Mono<SysMenuEntity> {
