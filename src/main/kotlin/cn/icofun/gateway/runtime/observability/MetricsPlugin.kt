package cn.icofun.gateway.runtime.observability

import cn.icofun.gateway.admin.monitor.model.entity.GatewayAccessLogEntity
import cn.icofun.gateway.runtime.security.DataMaskingPlugin
import cn.icofun.gateway.admin.monitor.service.log.AccessLogService
...
class MetricsPlugin(
    ...
    private fun returnError(exchange: ServerWebExchange, code: Int, message: String): Mono<Void> {
        exchange.response.statusCode = HttpStatus.valueOf(code)
